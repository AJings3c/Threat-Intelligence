...
> = {
  en: {
    ...
    investigationTitle: 'IOC Summary',
    investigationSubtitle: 'Observable summary, local evidence, STRIDE scenarios, enrichment and export.',
  ...
  zh: {
    ...
    investigationTitle: 'IOC 汇总',
    investigationSubtitle: '可观测对象汇总、本地证据、STRIDE 场景、富化与导出。',
    modelingTitle: '威胁建模',
